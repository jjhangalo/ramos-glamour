...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <PageCanvas size="list" className="space-y-8 py-8">
      ...
      <form className="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-[1.2fr_220px_220px_auto]">
        <input
          type="search"
          name="pesquisa"
        ...
        <button
          type="submit"
          className="rounded-md border border-slate-200 px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-slate-700 transition hover:bg-slate-50"
        >
          Filtrar
        </button>
      </form>
