...
export function CategoryManager({ categories }: CategoryManagerProps) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[380px_minmax(0,1fr)]">
      <FadeUp className="h-fit">
        <section className="rounded-xl border border-brand-midnight/5 bg-white p-6 shadow-sm focus-within:shadow-md transition-shadow">
      ...
      <FadeUp delay={0.2}>
        <section className="rounded-xl border border-brand-midnight/5 bg-white shadow-sm overflow-hidden">
          ...
          <StaggerContainer className="divide-y divide-brand-midnight/5">
            {categories.map((category) => (
              <StaggerItem key={category.id} className="px-5 py-4 transition-colors hover:bg-brand-bg/30">
