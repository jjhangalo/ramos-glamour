  ...
  return (
    <div className="space-y-12">
      <ProfileSectionHeader 
        ...
        description="Gira os seus dados de identificação e informações de contacto para uma melhor experiência."
      />
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-[9px] text-brand-midnight/30 tracking-widest mt-4 leading-relaxed uppercase">
              A sua conta está protegida. As credenciais de início de sessão não podem ser alteradas aqui.
            </p>
          </div>
        </div>
